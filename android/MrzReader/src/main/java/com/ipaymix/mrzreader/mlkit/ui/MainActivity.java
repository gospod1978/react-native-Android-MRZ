...
import com.ipaymix.mrzreader.model.AdditionalPersonDetails;
import com.ipaymix.mrzreader.model.DocType;
import com.ipaymix.mrzreader.model.EDocument;
import com.ipaymix.mrzreader.model.PersonDetails;
import com.ipaymix.mrzreader.util.AppUtil;
import com.ipaymix.mrzreader.util.DateUtil;
import com.ipaymix.mrzreader.util.Image;
import com.ipaymix.mrzreader.util.ImageUtil;
import com.ipaymix.mrzreader.util.PermissionUtil;
...
import static com.ipaymix.mrzreader.mlkit.ui.CaptureActivity.DOC_TYPE;
import static com.ipaymix.mrzreader.mlkit.ui.CaptureActivity.MRZ_RESULT;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void openCameraActivity() {
        Intent intent = new Intent(this, com.ipaymix.mrzreader.mlkit.ui.CaptureActivity.class);
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == R.id.btn_scan_id_card) {
            docType = DocType.ID_CARD;
            requestPermissionForCamera();
        } else if (id == R.id.btn_scan_passport) {
